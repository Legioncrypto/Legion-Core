...
/* Legion GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Legion"
#define QAPP_ORG_DOMAIN "legionproject.io"
#define QAPP_APP_NAME_DEFAULT "Legion-Qt"
#define QAPP_APP_NAME_TESTNET "Legion-Qt-testnet"
