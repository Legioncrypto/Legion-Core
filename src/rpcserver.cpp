...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Legion features */
        {"legion", "masternode", &masternode, true, true, false},
        {"legion", "listmasternodes", &listmasternodes, true, true, false},
        {"legion", "getmasternodecount", &getmasternodecount, true, true, false},
        {"legion", "masternodeconnect", &masternodeconnect, true, true, false},
        {"legion", "masternodecurrent", &masternodecurrent, true, true, false},
        {"legion", "masternodedebug", &masternodedebug, true, true, false},
        {"legion", "startmasternode", &startmasternode, true, true, false},
        {"legion", "createmasternodekey", &createmasternodekey, true, true, false},
        {"legion", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"legion", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"legion", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"legion", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"legion", "getmasternodescores", &getmasternodescores, true, true, false},
        {"legion", "mnbudget", &mnbudget, true, true, false},
        {"legion", "preparebudget", &preparebudget, true, true, false},
        {"legion", "submitbudget", &submitbudget, true, true, false},
        {"legion", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"legion", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"legion", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"legion", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"legion", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"legion", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"legion", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"legion", "checkbudgets", &checkbudgets, true, true, false},
        {"legion", "mnsync", &mnsync, true, true, false},
        {"legion", "spork", &spork, true, true, false},
        {"legion", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"legion", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"legion", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"legion", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"legion", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"legion", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> legion-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:18097/\n";
}
