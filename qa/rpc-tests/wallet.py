...
#   c) node1 mines 32 blocks, so now node 0 has 500000LEGN, node 1 has 4250LEGN, node2 has none.
#   d) node0 sends 601 LEGN to node2, in two transactions (301 LEGN, then 300 LEGN).
