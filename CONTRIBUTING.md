...
The Legion Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Legion Core project, and is not to be
confused with overall Legion Network Protocol consensus changes.

Whether a pull request is merged into Legion Core rests with the project merge
...
Patches that change Legion consensus rules are considerably more involved than
...
Where a patch set proposes to change the Legion consensus, it must have been
...
The project leader is the release manager for each Legion Core release.
