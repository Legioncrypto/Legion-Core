...
Intro
-----
Legion (LEGN) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. Legion utilizes an energy efficient proof-of-stake algorithm,
can be mined on any computer, and will never require specialized mining equipment.


Setup
-----
Unpack the files into a directory and run legion-qt.exe.

Legion Core is the original Legion client and it builds the backbone of the network.
However, it downloads and stores the entire history of Legion transactions;
