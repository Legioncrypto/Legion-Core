...
In order to support loading of multiple wallets in legion-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is legion.cpp.
...
Changes to legion.cpp
----------------------
legion.cpp is the entry point into legion-qt, and as such, will require some minor modifications to provide hooks for
