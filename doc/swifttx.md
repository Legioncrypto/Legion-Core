...
This mechanism has been integrated into Bitcore-Node-Legion which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/legion/insight-api-legion#web-socket-api](https://github.com/legion/insight-api-legion#web-socket-api)
* API: [https://github.com/legion/insight-api-legion#swifttx-transactions](https://github.com/legion/insight-api-legion#swifttx-transactions)
...
By default, the Legion Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Legion Core daemon:
