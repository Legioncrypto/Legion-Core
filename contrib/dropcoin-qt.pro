...
RESOURCES += src/qt/legion.qrc src/qt/legion_locale.qrc

TRANSLATIONS += src/qt/locale/legion_bg.ts \
                src/qt/locale/legion_de.ts \
                src/qt/locale/legion_en.ts \
                src/qt/locale/legion_es.ts \
                src/qt/locale/legion_fi.ts \
                src/qt/locale/legion_fr.ts \
                src/qt/locale/legion_it.ts \
                src/qt/locale/legion_ja.ts \
                src/qt/locale/legion_pl.ts \
                src/qt/locale/legion_pt.ts \
                src/qt/locale/legion_ru.ts \
                src/qt/locale/legion_sk.ts \
                src/qt/locale/legion_sv.ts \
                src/qt/locale/legion_vi.ts \
                src/qt/locale/legion_zh_CN.ts \
                src/qt/locale/legion_zh_TW.ts
